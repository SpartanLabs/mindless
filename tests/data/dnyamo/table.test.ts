...
describe('DynamoTable ', () => {
    ...
    const documentCollection =
        { Items: [{ attrs: { name: 'Ronald' } }, { attrs: { name: 'Donald' } }, { attrs: { name: 'McDonald' } }] };
    const parsedDocumentCollection = [{ name: 'Ronald' }, { name: 'Donald' }, { name: 'McDonald' }]
    ...
    describe('create() ', () => {
        test('succeeds', async () => {
            ...
            dynogelsModelMock.setup(c => c.create(testData, {}, It.isAny()))
    ...
    describe('getAll() ', () => {
        test('succeeds', async () => {
            ...
            expect(items).toEqual(parsedDocumentCollection.map((item) => {
    ...
    describe('getItems() ', () => {
        test('succeeds', async () => {
            ...
            dynogelsModelMock.setup(c => c.getItems(itemsToGet, {}, It.isAny()))
                .callback((a, b, c) => c(undefined, documentCollection.Items)).verifiable(TypeMoq.Times.once());
        ...
        test('errors', async () => {
            ...
            dynogelsModelMock.setup(c => c.getItems(itemsToGet, {}, It.isAny()))
                .callback((a, b, c) => c(errorMessage)).verifiable(TypeMoq.Times.once());
    ...
    describe('get() ', () => {
        ...
        test('with rangeKey succeeds', async () => {
            ...
            dynogelsModelMock.setup(c => c.get(hashKey, rangeKey, {}, It.isAny()))
                .callback((a, b, c, d) => d(undefined, document)).verifiable(TypeMoq.Times.once());
        ...
        test('item null returns undefined', async () => {
            ...
            dynogelsModelMock.setup(c => c.get(hashKey, {}, It.isAny()))
                .callback((a, b, c) => c(undefined, null)).verifiable(TypeMoq.Times.once());
        ...
        test('item undefined returns undefined', async () => {
            ...
            dynogelsModelMock.setup(c => c.get(hashKey, {}, It.isAny()))
                .callback((a, b, c) => c(undefined, undefined)).verifiable(TypeMoq.Times.once());
    ...
    describe('update() ', () => {
        test('succeeds', async () => {
            dynogelsModelMock.setup(c => c.update(testModel.model, {}, It.isAny()))
                .callback((a, b, c) => c(undefined, document)).verifiable(TypeMoq.Times.once());
    ...
    describe('delete() ', () => {
        test('with just haskKey succeeds', async () => {
            dynogelsModelMock.setup(c => c.destroy(hashKey, {}, It.isAny()))
                .callback((a, b, c) => c(undefined)).verifiable(TypeMoq.Times.once());
        ...
        test('with rangeKey succeeds', async () => {
            dynogelsModelMock.setup(c => c.destroy(hashKey, rangeKey, {}, It.isAny()))
                .callback((a, b, c, d) => d(undefined)).verifiable(TypeMoq.Times.once());
    ...
    describe('create() with mappedKeys ', () => {
        test('succeeds', async () => {
            ...
            dynogelsModelMock.setup(c => c.create(
                {
